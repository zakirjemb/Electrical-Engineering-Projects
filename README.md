# ⚡ Electrical Engineering Portfolio | Zekarias Jemberu
**GPA: 3.96/4.0** | Abu Dhabi University

## 🛰️ Research Experience
- **Pipeline Fault Detection (NYUAD):** [View Project](./Research/Pipeline-Sensing-NYUAD)
- **Passive Radar Systems (KU):** [View Project](./Research/Passive-Radar-KU)
- **Fiber Optic ML Detection:** [View Project](./Projects/Fiber-Optic-Fault-Detection)
...
## 🔋 Power & Electronics
- **Battery Charger Design:** 6V Lead-Acid AC-DC [Link](./Power/Lead-Acid-Battery-Charger)
- **Home Power Simulation:** MATLAB/Simulink [Link](./Power/Home-Electricity-Sim)
- **Automated Hospital Lighting:** Sensor Control [Link](./Electronics-Design/Automated-Hospital-Lighting)
